# Emma Neillie  
**MEng Electronic & Software Engineering Student**  
...
📌 **HUD-Mapping-Algorithms**  
Algorithms for mapping and visualizing HUD data in real time — combining signal processing and systems design.
...
| Area | Technologies |
|------|--------------|
| **Embedded Systems** | C, C++, Arduino, ESP32, STM32 |
| **Software Development** | Python, WPF (C#), .NET |
| **Data & Algorithms** | Signal Processing, Real-time Filtering |
| **Version Control** | Git & GitHub workflows |
| **Hardware** | Custom PCBs, Raspberry Pi, Sensors, CAN bus systems |
